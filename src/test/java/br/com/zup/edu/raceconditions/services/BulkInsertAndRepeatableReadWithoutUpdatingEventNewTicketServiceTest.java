...
class BulkInsertAndRepeatableReadWithoutUpdatingEventNewTicketServiceTest extends SpringBootIntegrationTest {

	@Autowired
	private BulkInsertAndRepeatableReadWithoutUpdatingEventNewTicketService bulkInsertAndRepeatableReadWithoutUpdatingEventNewTicketServiceTest;
	...
	void shouldBuyNoMoreThanMaxTickets() throws InterruptedException {
		...
		doSyncAndConcurrently(10, customerName -> {
			bulkInsertAndRepeatableReadWithoutUpdatingEventNewTicketServiceTest.buyNewTicket(EVENT.getId(), customerName);
		});
