...
class SerializableIsolationLevelTransferServiceTest extends SpringBootIntegrationTest {
    ...
    @Autowired
    private SerializableIsolationLevelTransferService serializableIsolationLevelTransferService;
    ...
    public void shouldTransferMoneyBetweenAccounts() throws InterruptedException {
        ...
        doSyncAndConcurrently(10, s -> {
            serializableIsolationLevelTransferService
