...
class SimpleTransferServiceTest extends SpringBootIntegrationTest {
    ...
    @Autowired
    private SimpleTransferService simpleTransferService;
    ...
    public void shouldTransferMoneyBetweenAccounts() throws InterruptedException {
        ...
        assertAll("transfer between accounts",
            () -> assertEquals(10, transferRepository.count()),
            () -> assertEquals(ZERO,
