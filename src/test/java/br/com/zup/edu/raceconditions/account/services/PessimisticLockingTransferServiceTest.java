...
class PessimisticLockingTransferServiceTest extends SpringBootIntegrationTest {
    ...
    @Autowired
    private PessimisticLockingTransferService pessimisticLockingTransferService;
    ...
    public void shouldTransferMoneyBetweenAccounts() throws InterruptedException {
        ...
        doSyncAndConcurrently(10, s -> {
            pessimisticLockingTransferService
