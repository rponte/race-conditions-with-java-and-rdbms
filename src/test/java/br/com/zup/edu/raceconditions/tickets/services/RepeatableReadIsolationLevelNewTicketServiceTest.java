...
class RepeatableReadIsolationLevelNewTicketServiceTest extends SpringBootIntegrationTest {

	@Autowired
	private RepeatableReadIsolationLevelNewTicketService repeatableReadIsolationLevelNewTicketService;
	...
	void shouldBuyNoMoreThanMaxTickets() throws InterruptedException {
		...
		doSyncAndConcurrently(10, customerName -> {
			repeatableReadIsolationLevelNewTicketService.buyNewTicket(EVENT.getId(), customerName);
		});
