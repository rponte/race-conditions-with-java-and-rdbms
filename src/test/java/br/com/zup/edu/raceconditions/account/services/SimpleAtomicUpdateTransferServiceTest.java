...
class SimpleAtomicUpdateTransferServiceTest extends SpringBootIntegrationTest {
    ...
    @Autowired
    private SimpleAtomicUpdateTransferService simpleAtomicUpdateTransferService;
    ...
    public void shouldTransferMoneyBetweenAccounts() throws InterruptedException {
        ...
        doSyncAndConcurrently(10, s -> {
            simpleAtomicUpdateTransferService
