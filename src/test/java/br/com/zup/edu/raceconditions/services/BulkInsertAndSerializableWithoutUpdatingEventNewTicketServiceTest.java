...
class BulkInsertAndSerializableWithoutUpdatingEventNewTicketServiceTest extends SpringBootIntegrationTest {

	@Autowired
	private BulkInsertAndSerializableWithoutUpdatingEventNewTicketService bulkInsertAndSerializableWithoutUpdatingEventNewTicketService;
	...
	void shouldBuyNoMoreThanMaxTickets() throws InterruptedException {
		...
		doSyncAndConcurrently(10, customerName -> {
			bulkInsertAndSerializableWithoutUpdatingEventNewTicketService.buyNewTicket(EVENT.getId(), customerName);
		});
