...
class BulkInsertAndRepeatableReadNewTicketServiceTest extends SpringBootIntegrationTest {

	@Autowired
	private BulkInsertAndRepeatableReadNewTicketService bulkInsertAndRepeatableReadNewTicketServiceTest;
	...
	void shouldBuyNoMoreThanMaxTickets() throws InterruptedException {
		...
		doSyncAndConcurrently(10, customerName -> {
			bulkInsertAndRepeatableReadNewTicketServiceTest.buyNewTicket(EVENT.getId(), customerName);
		});
